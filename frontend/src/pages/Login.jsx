  ...
  return (
    <div className="min-h-screen flex bg-[#f4f5f7]">
      <div className="hidden lg:flex lg:w-1/2 bg-[#0f2557] flex-col justify-between p-12">
        ...
        <p className="text-blue-300/50 text-xs">&copy; 2026 PT PLN Energi Primer Indonesia</p>
      </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-[#0f2557] text-white text-sm font-medium py-2.5 rounded hover:bg-[#0c1e47] disabled:opacity-60 transition-colors"
            >
